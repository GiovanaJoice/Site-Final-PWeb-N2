...
const client = new MongoClient("mongodb+srv://GiovanaJoice:hbcsMzVLfTqbHZql@cluster0.4bjaqqj.mongodb.net/?retryWrites=true&w=majority")
...
const getHashedPassword = (password) => {
  ...
  async function checkUser(client, email) {
    try {
      ...
      if (result !== null) {
        console.log("E-mail usado");
        return true;
      } else {
        console.log("E-mail inexistente em nosso banco de dados!");
        return false;
      }
    } finally {
      await client.close();
